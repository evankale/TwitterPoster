	...
	public void startTwitterStream()
	{
		...
		StatusListener listener = new StatusListener()
		{
			...
			public void onStatus(Status status)
			{
				try
				{
					System.out.println("Text recieved: @" + status.getUser().getScreenName() + " - " + status.getText()
							+ "\n");
			...
			{
				System.out.println("onDeletionNotice: Got a status deletion notice id:"
			...
			{
				System.out.println("onTrackLimitationNotice: Got track limitation notice:" + numberOfLimitedStatuses);
			}
			...
			{
				System.out
						.println("onScrubGeo: Got scrub_geo event userId:" + userId + " upToStatusId:" + upToStatusId);
			}
